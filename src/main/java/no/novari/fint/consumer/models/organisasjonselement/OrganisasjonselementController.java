package no.novari.fint.consumer.models.organisasjonselement;
...
public class OrganisasjonselementController {
    ...
    public OrganisasjonselementResources getOrganisasjonselement(
        ...
        if (cacheService == null) {
            if (StringUtils.isNotBlank($filter)) {
                return getOrganisasjonselementByOdataFilter(client, orgId, $filter);
            }
            throw new CacheDisabledException("Organisasjonselement cache is disabled.");
        }
        if (props.isOverrideOrgId() || orgId == null) {
        ...
        Stream<OrganisasjonselementResource> resources;
    ...
    public OrganisasjonselementResources getOrganisasjonselementByQuery(
        ...
        return getOrganisasjonselement(orgId, client, sinceTimeStamp, size, offset, query, request);
    }
    ...
    public ResponseEntity getStatus(
        ...
        return statusCache.handleStatusRequest(id, orgId, linker, OrganisasjonselementResource.class);
    }
